                    ...
                    <tfoot>
                        <tr>
                            ...
                            <?php if ($cart->total_items() > 0) { ?>
                                ...
                                <td><a href="../Fincompra/index.php" name="pagps" class="btn btn-success btn-block">Pagos <i class="glyphicon glyphicon-menu-right"></i></a></td>
                               <?php $_SESSION['total'] =  $cart->total();?>
                                <?php } ?>
                        </tr>
                    </tfoot>
                </table>
