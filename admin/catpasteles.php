        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation" class="active"><a href="catpasteles.php">CATEGORIA PASTELES</a></li>
        ...
        feather.replace();
            ...
            <div class="panel-body">
                ...
                <div id="products" class="row list-group">
                    <?php
                    //get rows query
                    $sql2='SELECT * from productos where categoria="pasteles"';
                    $result2 = $conexion -> query($sql2);
                    $precios = array();
                    for($i=0 ;$i<6 ; $i++ ){
                        array_push($precios,  ($i));
                    }
